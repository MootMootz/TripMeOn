    ...
    public class BddContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            var tourPackages = new List<TourPackage>            {
                ...
                new TourPackage { Id = 6, Name = "June Bloomings in Paris", DestinationId = 1, ThemeId = 2,Description="4 days tour",TimePeriodId=6,Price= 776,ImageId = 6 },
                ...
                new TourPackage { Id = 8, Name = "Floating village in tulip season", DestinationId = 5, ThemeId = 1,Description="4 days tour",TimePeriodId=4,Price= 776,ImageId = 8 },
            ...
            var transport = new List<Transportation> {
                ...
                new Transportation {  Id = 11, Type = "car", Price = 35, StartDate = new DateTime(2023, 01, 01), EndDate = new DateTime(2023, 12, 31), PartnerId = 1, DestinationId = 1, ImageId= 39, Description = "Rent a 2 cv to make the best pictures ever" },
