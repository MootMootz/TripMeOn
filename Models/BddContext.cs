...
namespace TripMeOn.Models
{
	public class BddContext : DbContext
	{
		...
		public void InitializeDb()
		{
			...
			{
				new Client { Id = 1, LastName = "Phone Mo", FirstName = "Nway Nway", Nickname = "Twitwitoo",  Email = "nnpm.gmail.com", Password = "123456", Address= "21 bis Rue des Rossays,91600, France",PhoneNumber="0778146263",ClientType="Instagrammer"},
				new Client { Id = 2, LastName = "Kanobi", FirstName = "Obiwan", Nickname = "Jedi", Email = "oldman.gmail.com", Password = "3546246", Address= "66 Clover Road, 43k67H,UK ",PhoneNumber="057789021",ClientType="TikToker"},

			};

			var employees = new List<Employee>
			{
				 new Employee { Id = 1, LastName = "Lieby", FirstName = "Karen", Nickname = "Kukus", Email = "mightK.gmail.com", Password = "4677646", Address= "3 Rue de Victor Hugo, 21670, France",PhoneNumber="0676455781",JobTitle="Admin"},
			};

			var partners = new List<Partner>
			{
				 new Partner { Id = 1, LastName = "BeauGoud", FirstName = "Sedar", Nickname = "BG", Email = "bogosse.gmail.com", Password = "0597970983", Address= "123 Avenue Fromenteau,45091, France",PhoneNumber="076543211",CompanyName="EasyGo"},
			};
